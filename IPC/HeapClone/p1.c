...
int main(int argc, char **argv) {
  ...
  student_t *stud1 =
      (student_t *)allocator_alloc_mem(vm_page_memory, sizeof(student_t));
  ...
  vm_page_xmit_data_t *vm_page_xmit_data = (vm_page_xmit_data_t *)calloc(
      1, sizeof(vm_page_xmit_data_t) + getpagesize());
  ...
  int sent_bytes =
      sendto(sockfd, vm_page_xmit_data, sizeof(vm_page_xmit_data_t) + page_size,
