...
#define mm_bind_blocks_for_deallocation(freed_meta_block_down,                 \
                                        freed_meta_block_top)                  \
...
static inline int
mm_get_hard_internal_memory_frag_size(block_meta_data_t *first,
...
static inline bool allocator_is_vm_page_free(void *base_address);
