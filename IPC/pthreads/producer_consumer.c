...
int main(int argc, char **argv) {
  long t1 = PRODUCER, t2 = CONSUMER, t3 = MONITOR;
  int i = 0;
  ...
  pthread_create(&(threads[PRODUCER].pthread_handle), &threads[PRODUCER].attr,
                 produce, (void *)t1);
  pthread_create(&(threads[CONSUMER].pthread_handle), &threads[CONSUMER].attr,
                 consume, (void *)t2);
  pthread_create(&(threads[MONITOR].pthread_handle), &threads[MONITOR].attr,
                 monitor, (void *)t3);
